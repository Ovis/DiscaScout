...
/// <summary>DISCAS詳細ページから取得したCDの曲目を保持する</summary>
...
/// <summary>CDがどのリリースカテゴリで現在観測されているかを保持する</summary>
...
/// <summary>InboxでCDを再確認する必要が生じた現在の理由を保持する</summary>
...
/// <summary>CDメタデータの意味のある変更履歴を保持する</summary>
...
/// <summary>通常スクレイピングで扱うDISCASのリリースカテゴリ</summary>
public enum DiscReleaseCategory { Upcoming = 1, New = 2 }

/// <summary>CDを未チェック状態にする理由</summary>
public enum DiscReviewReasonType { New = 1, TitleChanged = 2, ArtistMatched = 3, Reappeared = 4 }

/// <summary>DISCAS由来文字列の比較に使用する共通正規化を提供する</summary>
public static partial class DiscTextNormalizer
{
    /// <summary>表示文字列をNFKC・空白統合・大文字化して比較用文字列へ変換する</summary>
